...
public class EntelPeruAppTestVerifyUpselling implements ITest {
    ...
    public void verifyUpselling(AndroidDriver<AndroidElement> driver, String contentPath) throws InterruptedException {
        ...
        try {
            ...
            Thread.sleep(3000);
            String cardAdditionalLine = contentPath + "//*[@resource-id='b1-b1-MainContent']//*[@resource-id='b1-PromotionMain']";
            wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath(cardAdditionalLine)))
                    .click();
            ...
            testResult.setErrorMessage("Popup no puede ser inspeccionado en el arbol del elementos, dado que no es reconocido el componente.");
