...
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyRenewal;
import net.kiwox.dst.script.appium.entel_peru.EntelPeruAppTestVerifyUpselling;
import net.kiwox.dst.script.pojo.TestResult;
import org.apache.commons.cli.Option;
import org.apache.commons.cli.Options;

public class EntelPeruAppCommandVerifyRenewal extends AbstractCommand {
	...
	protected TestResult internalRunTest(String[] args) {
		if (parseCommandLine(args)) {
			...
			//String timeOut  = commandLine.getOptionValue(D)
			ITest test = new EntelPeruAppTestVerifyRenewal(phoneNumber, verificationCode);
			return startServer(test);
		}
		// TODO: Review response of below line
		TestResult result = new TestResult();
		result.setError(true);
		result.setCode("DST-MI-ENTEL-PERU-003");
		return result;
	}
	...
	protected String getCommandName() {
		return "app-entel-peru-verificar-upselling";
	}

	@Override
	protected String getErrorCode() {
		return "DST-MI-ENTEL-PERU-003";
	}
